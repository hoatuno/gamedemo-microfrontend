...
// const jumpAudio = baseConfig.resolvePath("audio/mario-jump.mp3");
// const backgroundMusic = baseConfig.resolvePath("audio/running-about.mp3");
// const dieAudio = baseConfig.resolvePath("audio/mario-died.mp3");
